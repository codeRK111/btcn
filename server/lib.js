...
exports.deriveAddress = function(index) {
  ...
  var value = new Buffer(index+'Nitikesh uyi ltcnyan Litecoin');
  var hash = litecoinjs.crypto.Hash.sha256(value);
  var bn = litecoinjs.crypto.BN.fromBuffer(hash);
  var address = new litecoinjs.PrivateKey(bn).toAddress();

    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>Bet:</th><td>' + (entry.bet/100).toFixed() + ' Lites</td></tr>' +
                ...
                '<tr><th>Bonus: </th><td>' + (entry.bonus ? (entry.bonus/100).toFixed(2) : 0) + ' Lites</td></tr>' +
                "<tr><th>Profit:</th><td><b>" + (profit/100).toFixed(2) + " Lites</b></td></tr>" +
                '</table>';
            return r;

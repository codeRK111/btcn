        ...
        render: function() {
            ...
            if(USER_MESSAGE && this.state.showMessage) {
                ...
                switch(USER_MESSAGE.type) {
                    ...
                    case 'newUser':
                        messageContent = D.span(null,
                            D.a({ href: "/request" }, "Welcome to ltcnyan.com, to start you have 2 free Lites, Lites you can request them here or you can just watch the current games... have fun :D")
                        );
                        messageClass = 'new-user';
                        break;
                    case 'received':
                        messageContent = D.span(null,
                            D.span(null, "Congratulations you have been credited " +  USER_MESSAGE.qty +  " free Lites. Have fun!")
                        );
                    ...
                    case 'collect':
                        messageContent = D.span(null,
                            D.a({ href: '/request' }, 'Collect your two free Lites!')
                        );
